...
type ReadBackup struct {
	...
	ReadFrom int32 `protobuf:"varint,1,opt,name=read_from,json=readFrom,proto3" json:"read_from,omitempty"`
}

func (x *ReadBackup) Reset() {
	*x = ReadBackup{}
...
func (x *ReadBackup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReadBackup) ProtoMessage() {}

func (x *ReadBackup) ProtoReflect() protoreflect.Message {
	mi := &file_backup_proto_msgTypes[0]
...
// Deprecated: Use ReadBackup.ProtoReflect.Descriptor instead.
func (*ReadBackup) Descriptor() ([]byte, []int) {
	return file_backup_proto_rawDescGZIP(), []int{0}
}

func (x *ReadBackup) GetReadFrom() int32 {
	if x != nil {
		return x.ReadFrom
	}
	return 0
...
var file_backup_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02,
	0x70, 0x62, 0x22, 0x29, 0x0a, 0x0a, 0x52, 0x65, 0x61, 0x64, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70,
	0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x66, 0x72, 0x6f, 0x6d, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x08, 0x72, 0x65, 0x61, 0x64, 0x46, 0x72, 0x6f, 0x6d, 0x42, 0x04, 0x5a,
...
var file_backup_proto_goTypes = []interface{}{
	(*ReadBackup)(nil), // 0: pb.ReadBackup
}
